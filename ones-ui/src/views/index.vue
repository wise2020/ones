    ...
    <el-row :gutter="20">
      <el-col :lg="24" :sm="24">
        <blockquote class="text-warning" style="font-size: 14px">
          ...
          <br/>
          阿里云服务器折扣区
          <el-link href="http://aly.ones.vip" target="_blank" type="primary"
          >>☛☛点我进入☚☚
          </el-link
          >
          &nbsp;&nbsp;&nbsp; 腾讯云服务器秒杀区
          <el-link href="http://txy.ones.vip" target="_blank" type="primary"
          >>☛☛点我进入☚☚
          </el-link
          >
          <br/>
      ...
      <el-col :lg="12" :sm="24" style="padding-left: 20px">
        ...
        <p>
          <el-button
            ...
            size="mini"
            type="primary"
            @click="goTarget('https://gitee.com/y_project/ones-Vue')"
          >访问码云
          </el-button
          >
          <el-button
